-- Migration Step 2: Rebuild materialized view with commission columns
-- Description: Update materialized view to include commission columns
...
-- Recreate materialized view with commission columns
CREATE MATERIALIZED VIEW monad_analytics.validator_registry_latest_mv
